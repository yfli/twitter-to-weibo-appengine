...
class RedisCache(Cache):
    ...
    def __init__(self, client, timeout=60, keys_container = 'tweibopy:keys', pre_identifier = 'tweibopy:'):
        Cache.__init__(self, timeout)
        self.client = client
    ...
    def store(self, key, value):
        ...
        # Prepend tweibopy to our key, this makes it easier to identify tweibopy keys in our redis server
